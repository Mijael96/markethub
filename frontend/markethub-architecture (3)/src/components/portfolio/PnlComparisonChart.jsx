...
import { fmtARS, fmtTime } from "../../utils/formatters";

export default function PnlComparisonChart({ data, currentTs }) {
  return (
    <Panel eyebrow={`Comparativa · a las ${fmtTime(currentTs)}`} title="PnL acumulado por conjunto">
